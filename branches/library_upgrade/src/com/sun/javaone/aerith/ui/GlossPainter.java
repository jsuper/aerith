/*
 * $Id: GlossPainter.java,v 1.3 2006/04/18 19:21:01 gfx Exp $
 *
...
public class GlossPainter extends AbstractPainter {
    ...
    protected void paintBackground(Graphics2D g, JComponent component) {
        if (getPaint() != null) {
            Ellipse2D ellipse = new Ellipse2D.Double(-component.getWidth() / 1.0,
                component.getHeight() / 3.7, component.getWidth() * 3.0,
