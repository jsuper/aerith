...
public class AerithSliderUI extends MetalSliderUI {
    private static Image GLOW;
    static {
        try {
            GLOW = ImageIO.read(AerithSliderUI.class.getResource("/resources/photos/slider-glow.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
...
//            g2.setComposite(composite);
            ...
            g2.setPaint(new GradientPaint(0, 2, new Color(0x818a9b), 0, 17, new Color(0x3a4252)));
            g2.fill(thumb);
            g2.setPaint(paint);
