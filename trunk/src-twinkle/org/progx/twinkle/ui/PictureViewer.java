...
//        }
    ...
    private static void initScene(GL2 gl) {
    ...
    private void renderItems(GL2 gl, boolean antiAliased) {
        for (Renderable renderable: renderables) {
            setAndRender(gl, renderable, antiAliased);
        }
    }
    
    private static void setAndRender(GL2 gl, Renderable renderable, boolean antiAliased) {
        if (renderable == null) {
            return;
        }
